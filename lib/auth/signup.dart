        ...
        child: SafeArea(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Text('85'.tr, style: AppFonts.DarkBLue_20),
                ),
                SizedBox(
                  height: 50,
                  child: Padding(
                    ...
                    child: Container(
                        ...
                        child: Text('86'.tr, style: AppFonts.grey_14)),
                  ),
                ),
                SizedBox(
                  height: 40,
                  child: Padding(
                      padding: EdgeInsets.only(left: 200),
                      child: Text('87'.tr, style: AppFonts.DarkBLue_16)),
                ),
                SizedBox(
                  height: 20,
                ),
                ...
                SizedBox(
                  child: Padding(
                    ...
                    child:
                        Center(child: Text('88'.tr, style: AppFonts.grey_14)),
                  ),
                  height: 40,
                ),
                RecButton(
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Text("84".tr, style: AppFonts.DarkBLue_16),
                    ),
                  ],
                ),
              ],
